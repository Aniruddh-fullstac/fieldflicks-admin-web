...
export const AdminApi = {
  ...
  async runMuxIngestionCycle(
    date: string,
  ): Promise<import('../types').AdminMuxIngestionCycleResult> {
    const res = await api.post('/admin/extraction-pipeline/mux-cycle', { date });
    return extractData<any>(res);
  },
  ...
  async getMuxCycleStatus(): Promise<import('../types').AdminMuxCycleProgress> {
    const res = await api.get('/admin/extraction-pipeline/mux-cycle/status');
    return extractData<any>(res);
  },
